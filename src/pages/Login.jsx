...
function Login() {
  ...
  return authLoading?<Loading/>:  (
    <div className=' w-full min-h-screen flex  bg-gray-50 dark:bg-gray-950 font-sans'>
      {/* Left/Bottom Container - Form */}
      <div className='relative px-6  w-full   md:w-1/2 flex flex-col justify-center items-center py-12  sm:px-12 lg:px-24 bg-white dark:bg-gray-900 z-11'>
        ...
        <div className='w-full  rounded-lg max-w-md space-y-8'>
          <div className='text-center'>
            ...
            <p className='mt-3 text-gray-500 dark:text-gray-400'>Please enter your details to sign in.</p>
          </div>
