      ...
      <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-800 p-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400">Track and manage the students you have selected or hired.</p>
          </div>
        ...
        <div className="min-h-[500px]">
          {loading ? (
            ...
            <div className="text-center py-20 bg-gray-50 dark:bg-gray-800/50 rounded-2xl border border-dashed border-gray-300 dark:border-gray-700">
              ...
              <p className="text-gray-500 dark:text-gray-400 mb-6">You haven't selected any students {filterStatus !== 'all' ? `with ${filterStatus} status` : 'yet'}.</p>
              <button 
                  ...
                  <div className="p-6 flex-1 flex flex-col">
                    <div className="flex justify-between items-start mb-5">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500 dark:text-gray-400 truncate w-32 md:w-40">
                    ...
                    <div className="mt-5 pt-4 border-t border-gray-100 dark:border-gray-800">
                      <button 
                        ...
                        className="w-full py-2.5 text-center text-indigo-600 dark:text-indigo-400 font-semibold rounded-xl hover:bg-indigo-50 dark:hover:bg-indigo-900/20 transition-colors border border-transparent hover:border-indigo-100 dark:hover:border-indigo-800 flex items-center justify-center"
                      >
