  ...
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
        ...
        <form onSubmit={handleApplyFilters} className="bg-gray-50 p-6 rounded-2xl border border-gray-200">
          ...
          <div className="mt-4 flex justify-end space-x-3">
            <button
              ...
              className="px-5 py-2 rounded-xl border border-gray-300 text-gray-700 font-medium hover:bg-gray-100 transition-colors"
            >
              Clear
            </button>
            <button
      ...
      <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 min-h-125">
        {loading ? (
                ...
                <div className="p-6">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">{student.user?.email || 'No email provided'}</p>
                    </div>
                    <div className="flex items-center justify-center bg-indigo-50 text-indigo-700 font-bold px-3 py-1 rounded-full text-sm">
                    ...
                    <div className="flex items-start text-gray-600 text-sm">
                      ...
                      <div className="flex-1 flex flex-wrap gap-1">
                        ...
                        {student.skills && student.skills.length > 4 && (
                          <span className="text-xs text-gray-500 mt-0.5">+{student.skills.length - 4} more</span>
                        )}
                      </div>
                    </div>
                  </div>
