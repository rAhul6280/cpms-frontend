      ...
      <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-800 p-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400">Review, approve, or reject student hiring selections across all recruiters.</p>
          </div>
        ...
        <div className="min-h-125">
          {loading ? (
            ...
            <div className="text-center py-20 bg-gray-50 dark:bg-gray-800/50 rounded-2xl border border-dashed border-gray-300 dark:border-gray-700">
              ...
              <p className="text-gray-500 dark:text-gray-400">There are no selections {filterStatus !== 'all' ? `with ${filterStatus} status` : 'yet'}.</p>
            </div>
          ) : (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {selections.map((selection) => (
                <div 
                  key={selection._id} 
                  className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 overflow-hidden hover:shadow-xl transition-all duration-300 flex flex-col h-full"
                >
                  ...
                  <div className="p-6 flex-1 flex flex-col">
                    <div className="flex justify-between items-start mb-5">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500 dark:text-gray-400 truncate w-32 md:w-48">
                    ...
                    <div className="space-y-3 flex-1 bg-gray-50 dark:bg-gray-800/50 p-4 rounded-xl border border-gray-100 dark:border-gray-800">
                      <div className="flex items-center text-sm">
                        ...
                        <span className="text-gray-600 dark:text-gray-400 font-medium w-24">Recruiter:</span>
                        <span className="text-gray-900 dark:text-white font-semibold truncate flex-1">{selection.recruiter?.fullName || 'Unknown Company'}</span>
                      </div>

                      <div className="flex items-center text-sm">
                        <FaBriefcase className="w-4 h-4 text-indigo-400 mr-3" />
                        <span className="text-gray-600 dark:text-gray-400 font-medium w-24">Role:</span>
                      ...
                      <div className="flex items-center text-sm">
                        ...
                        <span className="text-gray-600 dark:text-gray-400 font-medium w-24">CTC:</span>
                      ...
                      <div className="flex items-center text-sm">
                        ...
                        <span className="text-gray-600 dark:text-gray-400 font-medium w-24">Date:</span>
                    ...
                    {selection.status === 'pending' && (
                      <div className="mt-5 pt-4 border-t border-gray-100 dark:border-gray-800 flex gap-3">
                        ...
                        <button 
                          ...
                          className="flex-1 py-2.5 bg-red-100 dark:bg-red-900/30 hover:bg-red-200 dark:hover:bg-red-900/50 text-red-700 dark:text-red-400 font-semibold rounded-xl transition-colors flex items-center justify-center disabled:opacity-70"
                        >
                          Reject
                        </button>
                      </div>
